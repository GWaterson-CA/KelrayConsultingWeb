...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 text-left text-base font-medium text-white transition-all hover:text-cyan-200 [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
