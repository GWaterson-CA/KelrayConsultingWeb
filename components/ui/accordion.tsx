...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 text-left text-base font-medium text-slate-900 transition-all hover:text-blue-600 [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
