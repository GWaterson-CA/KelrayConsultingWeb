...
export function CaseStudyCard({ caseStudy }: CaseStudyCardProps) {
  ...
  return (
    <Card className="group overflow-hidden border-white/10 p-0 transition duration-300 hover:border-cyan-300/40 hover:bg-white/[0.08]">
      ...
      <div className="space-y-4 p-6">
        ...
        <Link href={`/case-studies/${caseStudy.slug}`} className="inline-flex text-sm font-medium text-cyan-200 hover:text-cyan-100">
          View case study
        </Link>
      </div>
    </Card>
